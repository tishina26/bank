      ...
      <div className='results__container'>
        ...
        <div className='results__cons'>
          ...
          <div className='ahketa__btns ahketa-res__btns'>
              ...
              <p className='res__text'>Для того, чтобы всё сделать грамотно, Вам необходимо правильно оформить все документы. Воспользуйтесь составленными нами шаблонами и полным пакетом документов, необходимыми для прохождения процедуры банкротства.</p>
