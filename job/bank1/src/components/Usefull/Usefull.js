      ...
      <div className="about-project__dev">
        <h2 className="about-project__header">Что такое банкротство?</h2>
            <div className="aboutme__container">
                ...
                <p className="usefull__text1" name='both' id='both'>Есть два способа оформить банкротство:</p>
                ...
                <div className="usefull__table">
                  ...
                  <div className="table_col1">
                  <p className="table__text"><b className="text__termin" tooltip='Обязанность пройти только эту процедуру'><b>Обязанность</b></b></p>
                    ...
                    <p className="table__text">Госпошлина: 300 р. Вознаграждение арбитражному управляющему: от 25 до 75 тыс. руб.</p>
                  </div>
                  <div className="table_col1">
                  <p className="table__text"><b className="text__termin" tooltip='Право воспользоваться этой процедурой или выбрать другую'><b>Право</b></b></p>
                  <p className="table__text"><b className="text__termin" tooltip='Нет минимума долга, но есть обязательные расходы на процедуру от 25 300 р'>нет минимума</b></p>
                ...
                <p className=""><b>Внесудебное банкротство</b> - это процедура бесплатного банкротства для граждан через обращение в МФЦ.</p>
